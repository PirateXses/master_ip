...
set id 31
set name master_ip_dadd_64ns_64ns_64_4_full_dsp
...
set id 32
set name master_ip_dmul_64ns_64ns_64_4_max_dsp
...
set id 34
set name master_ip_sitodp_32ns_64_3
...
set id 36
set name master_ip_dsqrt_64ns_64ns_64_17
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 37 \
			corename master_ip_AXILiteS_axilite \
			name master_ip_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler master_ip_AXILiteS_s_axi
}
