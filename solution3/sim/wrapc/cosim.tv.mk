...
$(ObjDir)/master_ip_test.cpp_pre.cpp.tb.o : master_ip_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling master_ip_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/master_ip.cpp_pre.cpp.tb.o : master_ip.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling master_ip.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/uart_to_coordinates.cpp_pre.cpp.tb.o : uart_to_coordinates.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling uart_to_coordinates.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
