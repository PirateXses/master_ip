...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "master_ip.autotvin.dat"
	set constFileTvOut       "master_ip.autotvout.dat"
	set constFileHdlTvIn     "master_ip.autohdltvin.dat"
	set constFileHdlTvOut    "master_ip.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
