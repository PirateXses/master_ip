...
if {[file isfile master_ip.autotvin.dat]} {
	file delete -force master_ip.autotvin.dat
}

if {[file isfile master_ip.autotvout.dat]} {
	file delete -force master_ip.autotvout.dat
}
